...
var displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    ...
    scrollZoom: false // center: [-118.5425706, 34.0471887],
    // zoom: 10,
    // interactive: false
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": {loc.description}</p>")).addTo(map);
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            if (res.data.success = 'success') location.assign('/');
            _context2.next = 11;
            break;
...
var stripe = Stripe('pk_test_51HaVdTC6gnC57jav5VglcxlpupF8LHQUanwAwrTEGOtSILD7vwg0sYaa61BlDIedgguV1yBU4o7wW3eD93bZqPFE00fy301LRJ');
